                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="text" class="form-control @error('fname') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="sex" id="sex" class="form-control @error('sex') is-invalid @enderror">
                                    <option value="F" @if (old('sex')=='F' ) selected="selected" @endif>Femal</option>
                                    <option value="M" @if (old('sex')=='M' ) selected="selected" @endif>Male</option>
                                </select>
                                @error('sex')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
